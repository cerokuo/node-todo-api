...
describe('GET /todos/:id', () =>{
	...
	it('should not retrun todo doc created for another user', (done) => {
		request(app)
...
describe('DELETE /todos/:id', () => {
  ...
  it('shouldnt remove a todo that you didnt create', (done) => {
...
describe('PATCH /todos/:id', () => {
	it('should update the first todo as first user', (done) => {
		var hexId = todos[0]._id.toHexString();
...
// auth as first user
	...
	it('should update the first todo as second user', (done) => {
		var hexId = todos[0]._id.toHexString();
		var text = 'new update text to write';
		request(app)
		.patch(`/todos/${hexId}`)
